...
@property (copy, nonatomic) NSString *wiki_name;
@property (copy, nonatomic) NSString *wiki_type;
@property (copy, nonatomic) NSString *wiki_parent;
@property (copy, nonatomic) NSString *wiki_date;
@property (copy, nonatomic) NSString *wiki_modified;
@property (copy, nonatomic) NSString *wiki_modified_user;
@property (strong, nonatomic) NSArray *wiki_meta;// @[@{meta_value, meta_key, meta_type}, @{meta_key, meta_type, meta_value = @{bg = @{url, color, position}}}];
@property (copy, nonatomic) NSString *wiki_fm_url;
@property (copy, nonatomic) NSString *wiki_url;
@property (copy, nonatomic) NSDictionary *wiki_cover;// @{small, medium, square, large};
